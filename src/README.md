# Welcome to rskj federate node

## About

rskj is a pure-Java implementation of the RSK protocol. For high-level information about RSK and its goals, visit [www.rsk.co](http://www.rsk.co). The [RSK white paper](https://uploads.strikinglycdn.com/files/90847694-70f0-4668-ba7f-dd0c6b0b00a1/RootstockWhitePaperv9-Overview.pdf) provides a complete conceptual overview of the platform.

## Check our [blog](http://media.rsk.co)

## Report Security Vulnerabilities

We have a [vulnerability reporting guideline](https://github.com/rsksmart/federate-node/blob/master/SECURITY.md) for details on how to
...
```bash
git clone https://github.com/rootstock/federate-node
cd federate-node
```
...
**Now you're ready to run the proyect.**
...
### Running Federate node using local RSKj source code

If you need to run the Federate node using a local version of RSKj instead of relying on the dependencies been resolved by Maven, you will have to add a customization file.
...
## Configuring rskj federate node (THIS CHANGES BEFORE GO LIVE)
