...
public class ConfirmedBlockHeadersProvider {
    ...
    public List<Block> getConfirmedBlockHeaders(Keccak256 startingPoint) {
        ...
        while (blockToProcess != null && confirmedBlocks.size() < maximumElementsToSendHSM) {
            ...
            BigInteger difficultyToConsider = getBlockDifficultyToConsider(blockToProcess.getHash(), blockToProcess.getDifficulty().asBigInteger());
            ...
            if (accumulatedDifficulty.compareTo(minimumAccumulatedDifficulty) >= 0) { // Enough difficulty accumulated
                ...
                BigInteger confirmedBlockDifficultyToConsider = getBlockDifficultyToConsider(confirmedBlock.getHash(), confirmedBlock.getDifficulty().asBigInteger());
    ...
    private BigInteger getBlockDifficultyToConsider(Keccak256 blockHash, BigInteger blockDifficulty) {
