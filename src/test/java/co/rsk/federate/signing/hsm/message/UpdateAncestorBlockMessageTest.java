...
public class UpdateAncestorBlockMessageTest {

//    @Test
//    public void getData_ok() {
//        byte[] encodedBlockHeader1 = new byte[]{ 1 };
//        BlockHeader blockHeader1 = mock(BlockHeader.class);
//        when(blockHeader1.getEncoded(false, false )).thenReturn(encodedBlockHeader1);
//
...
//        when(blockHeader2.getEncoded(false, false)).thenReturn(encodedBlockHeader2);
//
